...
const JobPageRight: React.FC<JobCardProps> = ({ data }) => {
  return (
    <>
        ...
        <div className="space-y-4">
          <div className="flex items-center">
            ...
            <div className="ml-6">
              ...
              <p className="font-semibold">{data.about.posted_on}</p>
            </div>
          </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-6">
              ...
              <p className="font-semibold">{data.about.deadline}</p>
            </div>
          </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-6">
              ...
              <p className="font-semibold">{data.about.start_date}</p>
            </div>
          </div>
          <div className="flex items-center">
            <div className="flex items-center justify-center w-12 h-12 border border-gray-300 rounded-full">
            ...
            <div className="ml-6">
              ...
              <p className="font-semibold">{data.about.end_date}</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-2 mt-2">
              {data.about.categories.map((category, index) => (
                <span
                  key={category}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {data.about.required_skills.map((skill, index) => (
                <span
                  key={index}
